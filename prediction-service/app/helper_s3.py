...
def get_latest_model_id(s3_client,bucket_name,prefix):
...
if __name__ == "__main__":
    conf = read_config("/home/teamjurassicpark/rohan/M3/movie-prediction-group-project-jurassicpark/prediction-service/config/config.json")
    bucket_name = conf['aws_access']['bucket_name']
    s3_client = start_s3_client(conf['aws_access'])
